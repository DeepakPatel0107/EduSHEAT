...
<%
    ...
    while (rs.next()) {
        ...
        String branch = rs.getString("branch").substring(0, 3);
...
<script language='javascript'>location.href = "FacultyPages/profileDetails.jsp"</script>
<%
...
<script language='javascript'>location.href = "FacultyPages/index.jsp"</script>
<%
            }
