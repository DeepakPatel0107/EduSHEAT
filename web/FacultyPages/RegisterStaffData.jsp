...
<%
    ...
    String query1 = "insert into staff_registration (regId,password,name,email,mobile,yearOJ, staffBranch,post,status,id) values('" + regID + "','" + password + "','" + name + "','" + email + "','" + mobile + "','" + year + "','" + branch + "','" + post + "','0','" + id + "')";
