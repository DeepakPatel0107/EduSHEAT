                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="pt-3">
                                            ...
                                            <div class="mt-3">
                                                <button type="button" style="border: none; background-color: white" onclick="registerStaff1()"><a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" style="min-height:40px;min-width:200px; color: white">Register</a></button> 
                                            </div>
