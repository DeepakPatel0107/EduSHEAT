     ...
     <div class="main-panel">
                                                    ...
                                                    <table id="order-listing" class="table" style="border-style:outset ">
                                                        ...
                                                        <tbody>
                                                            <%                                                  
                                                                ...
                                                                String query1 = "SELECT * FROM course where sem='" + request.getParameter("year") + "' and branch='" + request.getParameter("branch") + "'";
      ...
      <script>
            ...
            function fetchDetails()
            {
                ...
                location.href = "course.jsp?year=" + year + "&branch=" + branch;
                value()
