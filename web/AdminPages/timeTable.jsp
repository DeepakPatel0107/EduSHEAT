                    ...
                    <div class="content-wrapper">
                       ...
                       <div class="row grid-margin">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Time Table Details</h4>
                        ...
                        <div class="row grid-margin">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Time Table Record</h4>
                                        <div class="card-body">                                    
                                            <div class="col-12">
                                                    ...
                                                    <table id="order-listing" class="table" style="border-style:outset ">
                                                        ...
                                                        <tbody>
                                                            <%                                                  
                                                                ...
                                                                String query1 = "SELECT * FROM timetable where semester='" + request.getParameter("year") + "' and branch='" + request.getParameter("branch") + "'";
...
<script>
            ...
            function fetchDetails()
            {
                ...
                location.href = "timeTable.jsp?year=" + year + "&branch=" + branch;
                value()
