              ...
              <div class="card">
                        ...
                        <div class="card">
                          ...
                          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion-1">
                            <div class="card-body">
                                 ...
                                 <form class="pt-3" action="../UploadCircular" method="POST" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-lg" id="title" name="title" placeholder="Title of the Notes" required>
                                      ...
                                      <div class="form-group">
                    <select type="text" class="form-control form-control-lg" id="title" name="branch"  required>
                   ...
                   <div class="form-group">
                       <input type="file" class="form-control form-control-lg" id="circular"  name="circular" required>
                  ...
                  <div class="mt-3">
                      <button type="submit" style="border: none; background-color: white"><a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" style="color: white">Upload Circular</a></button> 
                </div>
              </form> 
