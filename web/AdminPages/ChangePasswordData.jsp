...
<%
   String id= session.getAttribute("admin_id").toString();
    ...
    String pass="";
     ResultSet rs = new GetQuery().getResultSetQuery("select password from admin_staff_login where regId='" + id + "'");
    if (rs.next()) {
        pass = rs.getString(1);
    }
    if(oldps.equals(pass))
    {
         String query = "update admin_staff_login set password='" + newps + "' where regId='" + id + "'";
