      ...
      <!-- partial -->
                                                                        ...
                                                                        <table id="order-listing" class="table" style="border-style:outset ">
                                                                            ...
                                                                            <tbody >
                                                                                <%
                                                                                    ...
                                                                                    String query = "select * from assignment_upload where semester='" + request.getParameter("year") + "' and branch='" + request.getParameter("branch") + "'";
                                                                                    %>
       ...
       <script>
            ...
            function fetchDetails()
            {
                ...
                location.href = "marks.jsp?year=" + year + "&branch=" + branch;
                value()
