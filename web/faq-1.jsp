                ...
                <div class="container">
					<div class="row">
						<div class="col-lg-8 col-md-12">
							...
							<p class="m-b10">Have questions? Look no further. Our Frequently Asked Questions (FAQ) make it easy for you to find answers to your most pressing inquiries into the School of Education. If you can't find your answer here, please feel free to contact us or use our site search to find the information you need.</p>
								...
								<div class="panel">
									<div class="acod-head">
										<h6 class="acod-title"> 
											...
											Who should take an Online Course? </a> </h6>
									</div>
									<div id="faq1" class="acod-body collapse">
										<div class="acod-content">Students join our online courses for a variety of reasons and come from diverse backgrounds, professions, and age groups. With online courses, you can
...
Whatever the reason, our online courses are a flexible way of learning about the art world without disrupting your daily life.</div>
									</div>
								</div>
								<div class="panel">
									<div class="acod-head">
										<h6 class="acod-title"> 
											...
											Are there prerequisites or language requirements?</a> </h6>
									</div>
									<div id="faq2" class="acod-body collapse">
										<div class="acod-content">There are no prerequisites. Our courses are open to students of all backgrounds who are 18 years of age and older.
All courses are conducted in English.</div>
									</div>
								</div>
								<div class="panel">
									<div class="acod-head">
										<h6 class="acod-title"> 
											...
											Can I take more than one course at a time? </a> </h6>
									</div>
									<div id="faq3" class="acod-body collapse">
										<div class="acod-content">If you are new to online learning, we recommend that you begin with one course. As our courses are offered frequently throughout the year, you can always come back and continue your studies with one or more topics.</div>
									</div>
								</div>
								<div class="panel">
									<div class="acod-head">
										<h6 class="acod-title"> 
											...
											How do I enroll and register? </a> </h6>
									</div>
									<div id="faq4" class="acod-body collapse">
										<div class="acod-content">Click on "Join Now" and fill the asked details to get register. </div>
									</div>
								</div>
								<div class="panel">
									<div class="acod-head">
										<h6 class="acod-title"> 
											...
											How SHEAT College Student get registered ? </a> </h6>
									</div>
									<div id="faq5" class="acod-body collapse">
										<div class="acod-content">SHEAT College students will be enrolled or registered by their college faculty members only. UserId and Passweord will be provided to them by convenient medium. </div>
									</div>
								</div>
                                                            <div class="panel">
									<div class="acod-head">
										<h6 class="acod-title"> 
											...
											How I will get UserId and Password ? </a> </h6>
									</div>
									<div id="faq6" class="acod-body collapse">
										<div class="acod-content">If you are SHEAT College students then you will be enrolled or registered by their college faculty members only. Outside the college students will get UserId and Password at the time of registration. </div>
									</div>
								</div>
                                                            <div class="panel">
									<div class="acod-head">
										<h6 class="acod-title"> 
											...
											What if I forgot my UserId and Password ? </a> </h6>
									</div>
									<div id="faq7" class="acod-body collapse">
										<div class="acod-content">In case you forgot your credential, you have to contact the administrator and Admin will send the credentials to you. </div>
									</div>
								</div>
							</div>
							<p class="m-b10">The purpose of an FAQ is generally to provide information on frequent questions or concerns; however, the format is a useful means of organizing information, and text consisting of questions and their answers may thus be called an FAQ regardless of whether the questions are actually frequently asked.</p>
