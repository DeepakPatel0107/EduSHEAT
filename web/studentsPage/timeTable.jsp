	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<h4 class="breadcrumb-title">Time Table</h4>
                                    ...
                                    <div class="ttr-box portfolio-bx">
                                        <div class="ttr-media media-ov2 media-effect">
                                            <a href="javascript:void(0);">
                                                <iframe  width="950" height="475" src="<%= "../" + rs1.getString("img_file") + "/" + rs1.getString("img_name")%>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                            </a>
                                            <div class="ov-box">
                                                <div class="overlay-icon align-m"> 
                                                   
                                                    <a  href="<%= "../" + rs1.getString("img_file") + "/" + rs1.getString("img_name")%>" class="magnific-anchor" title="<%= rs1.getString("branch")+" Time Table of "+rs1.getString("semester")+" Semester Updated On "+rs1.getString("date")%>">
                                                        <i class="ti-search"></i> 
                                                    </a>
                                                </div>
                                                <div class="portfolio-info-bx bg-primary">
                                                    <input type="text" value="<%= rs1.getString("Semester")+" "+"Semester"%> " disabled >
