...
<%
                                            ...
                                            <ul class="inbox-nav inbox-divider">
                                                <li class="active">
                                                    <a href="mails.jsp"><i class="fa fa-inbox"></i> Inbox <span class="label label-danger pull-right"></span></a>
                                                ...
                                                <div class="modal-body">
                                                    <form role="form" class="form-horizontal">
                                                        <div class="form-group">
                                                            <label class="col-lg-2 control-label">From</label>
                                                            <div class="col-lg-12">
                                                                <input type="text" placeholder="" id="mailFrom" name="mailFrom" class="form-control " disabled>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-lg-2 control-label">Subject</label>
                                                            <div class="col-lg-12">
                                                                <input type="text" placeholder="" id="subject1" class="form-control" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-lg-2 control-label">Message</label>
                                                            <div class="col-lg-12">
                                                                <textarea rows="10" cols="30" class="form-control" id="message" name="" disabled></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <iframe class="btn green fileinput-button fa fa-file-pdf" height="400px" width="700px" id="doc" src=""></iframe>   
                                                        ...
                                                        <div class="form-group" id="myDiv">
                                                            <div class="col-lg-offset-2 col-lg-10">
                                                                <span class="btn green fileinput-button" onclick="deleteCall(mailId)">
    ...
    <script>
        ...
        function details()
        {
            ...
            $.ajax({
                url: "readMailData.jsp",
                type: 'POST',
                data: {mailId: mailId},
                success: function (msg) {

                    var mailFrom = msg.split(",")[0].trim();
                    var subject = msg.split(",")[1].trim();
                    var message = msg.split(",")[2].trim();
                    var doc_name = msg.split(",")[3].trim();
                    var doc_file = msg.split(",")[4].trim();
                    callSetValues(mailFrom, subject, message, doc_name, doc_file);

                }

            });
            function callSetValues(mailFrom, subject, message, doc_name, doc_file)
            {
                document.getElementById("mailFrom").value = mailFrom;
                document.getElementById("subject1").value = subject;
                document.getElementById("message").value = message;
                if (doc_name == "")
                {
                    document.getElementById("doc").src = "../AdminPages/assets/images/favicon.png";
                } else
                {
                    document.getElementById("doc").src = "../" + doc_file + "/" + doc_name;
                }
