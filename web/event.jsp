								...
								<div class="event-bx m-b30">
									...
									<div class="info-bx d-flex">
										...
										<div class="event-info">
											<h4 class="event-title"><a href="#">Dharohar</a></h4>
											<ul class="media-post">
												
												<li><a href="#"><i class="fa fa-map-marker"></i> SHEAT College</a></li>
											</ul>
											<p>Annual function happens to be one of the most important functions in the school/ colleges. </p>
										</div>
									</div>
								</div>
							</li>
							<li class="action-card col-lg-6 col-md-6 col-sm-12 upcoming">
								<div class="event-bx m-b30">
									...
									<div class="info-bx d-flex">
										...
										<div class="event-info">
											<h4 class="event-title"><a href="#">TechnoParv</a></h4>
											<ul class="media-post">
												
												<li><a href="#"><i class="fa fa-map-marker"></i> SHEAT College</a></li>
											</ul>
											<p>College event organised by college students with various programs and activities.</p>
										</div>
									</div>
								</div>
							</li>
									...
									<div class="info-bx d-flex">
										<div>
											<div class="event-time">
												...
												<div class="event-month">Decemver</div>
											</div>
										</div>
										<div class="event-info">
											<h4 class="event-title"><a href="#">Even Semester Exams</a></h4>
											<ul class="media-post">
												
												<li><a href="#"><i class="fa fa-map-marker"></i> SHEAT College</a></li>
											</ul>
											<p>Semester Exams conducted by AKTU for evaluating students.</p>
										</div>
									</div>
								</div>
							</li>
							<li class="action-card col-lg-6 col-md-6 col-sm-12 happening">
								<div class="event-bx m-b30">
									...
									<div class="info-bx d-flex">
										...
										<div class="event-info">
											<h4 class="event-title"><a href="#">Odd Semester Practicals</a></h4>
											<ul class="media-post">
												
												<li><a href="#"><i class="fa fa-map-marker"></i> SHEAT College</a></li>
											</ul>
											<p>Odd Semester Practicals are performed to test the practical knowledge of students.</p>
										</div>
									</div>
								</div>
							</li>
							<li class="action-card col-lg-6 col-md-6 col-sm-12 expired">
								<div class="event-bx m-b30">
									...
									<div class="info-bx d-flex">
										...
										<div class="event-info">
											<h4 class="event-title"><a href="#">Pre University Test</a></h4>
											<ul class="media-post">
												
												<li><a href="#"><i class="fa fa-map-marker"></i> SHEAT College</a></li>
											</ul>
											<p>Pre University Test (PUT) is taken by college for evolution of student and make them aware of final semester exams.</p>
										</div>
									</div>
								</div>
							</li>
							<li class="action-card col-lg-6 col-md-6 col-sm-12 happening">
								<div class="event-bx m-b30">
									...
									<div class="info-bx d-flex">
										...
										<div class="event-info">
											<h4 class="event-title"><a href="#">Final Year Project Submission</a></h4>
											<ul class="media-post">
												
												<li><a href="#"><i class="fa fa-map-marker"></i> SHEAT College</a></li>
											</ul>
											<p>Submission of final year projects of all branch students.</p>
										</div>
									</div>
								</div>
							</li>
