...
@WebServlet(name = "staffProfileDetails", urlPatterns = {"/staffProfileDetails"})
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 1,maxFileSize = 1024 * 1024 * 10)
public class staffProfileDetails extends HttpServlet {

      private static final String SAVE_DIR = "Staff_Profile";
    boolean st = false;
    ...
    int i = new DBConnection().getQuery(query);
            ...
            if(i>0)
            {
               ...
               RequestDispatcher requestDispatcher = request
                    .getRequestDispatcher("StaffLogin.jsp");
