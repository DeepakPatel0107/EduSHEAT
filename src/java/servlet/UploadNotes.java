...
public class UploadNotes extends HttpServlet {
    ...
    private static final String SAVE_DIR = "Notes";
    boolean st = false;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Part file1 = null;
        String filePath1 = null, fileName1 = null;
        try {
...
//            UpdateProfilePicture.resize(inputImagePath, outputImagePath1, scaledWidth, scaledHeight);
              ...
              file1 = request.getPart("file");
            String savePath1 = getServletContext().getRealPath("") + File.separator + SAVE_DIR;
        ...
        String query = "insert into edusheat.notes( branch, semester,title, date, img_name, img_file, img_path, doc_name, doc_file, doc_path) values('" + branch + "','" + semester + "','" + title + "','" + date + "','" + fileName1 + "','" + SAVE_DIR + "','" + filePath1 + "','" + fileName + "','" + SAVE_DIR + "','" + filePath + "')";
        int i = new DBConnection().getQuery(query);
        if (i > 0) {
out.print("<script>location.href='FacultyPages/studyMaterials.jsp';</script>");
          //  response.sendRedirect("http://localhost:8084/SHEAT_Education/FacultyPages/studyMaterials.jsp");
        } else {
